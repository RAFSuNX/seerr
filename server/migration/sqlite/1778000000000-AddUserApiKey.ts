...
export class AddUserApiKey1778000000000 implements MigrationInterface {
  name = 'AddUserApiKey1778000000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "user" ADD COLUMN "apiKey" varchar`);
    await queryRunner.query(
      `CREATE UNIQUE INDEX "UQ_user_apiKey" ON "user" ("apiKey")`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "UQ_user_apiKey"`);
