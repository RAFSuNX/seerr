          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 rounded-xl bg-white/[0.06] px-3 py-2 ring-1 ring-white/[0.08] backdrop-blur-md">
              ...
              >
                ...
                <option value={SortOptions.ReleaseDateDesc}>{intl.formatMessage(messages.sortReleaseDateDesc)}</option>
                <option value={SortOptions.ReleaseDateAsc}>{intl.formatMessage(messages.sortReleaseDateAsc)}</option>
