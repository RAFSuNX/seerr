    ...
    <>
      ...
      <div className="relative bg-black">
        ...
        <div className="relative -mx-4 -mt-16 min-h-[100svh] sm:h-[82vh] sm:min-h-[520px]">
          ...
          <div className="absolute bottom-[61px] left-1/2 -translate-x-1/2 animate-bounce opacity-30 pointer-events-none">
        ...
        <div className="divide-y divide-white/[0.06] pt-6 pb-8">
          ...
          <div className="py-6">
            ...
            {sortedCrew.length > 0 && (
              <div className="-mt-1 border-t border-white/[0.06] pt-0">
