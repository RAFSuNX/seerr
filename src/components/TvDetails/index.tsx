...
const TvDetails = ({ tv }: TvDetailsProps) => {
  ...
  return (
    ...
    <div className="relative bg-black">
      ...
      <div className="relative -mx-4 -mt-16 h-[600px] sm:h-[82vh] min-h-[520px] overflow-hidden">
        <CachedImage
          type="tmdb"
          alt=""
          src={
        ...
        <div className="absolute inset-0 flex flex-col justify-center gap-3 px-4 pt-24 sm:inset-auto sm:bottom-0 sm:left-0 sm:right-0 sm:flex-row sm:items-end sm:gap-5 sm:pb-8 sm:pt-0 sm:px-6 lg:px-8">
          <div className="w-2/5 flex-shrink-0 overflow-hidden rounded-xl ring-1 ring-white/15 shadow-2xl mt-[30px] sm:mt-0 sm:w-32 lg:w-36">
            <CachedImage
              type="tmdb"
              src={
                data.posterPath
